...
const Card = ({ title, image }: Deal) => (<div class="swiper-slide ">
    <div class="flex items-center cursor-pointer gap-2">
      <Image src={image || "https://placehold.co/24x24"} alt={title || "Imagem de condição"} width={24} height={24} fetchPriority="low"/>
      <div class="flex">
